...
public class APIWorkflowSteps {
    ...
    public void the_status_code_for_creating_an_employee_is_201(Integer Int1){
    ...
    // this path of employee file is coming from feature file
...
//-----------------------------------------------------------------------
    ...
    public void a_request_is_prepared_to_get_created_employee() {
    ...
    @Then("the employee data we get having {string} must match with globaly stored employee")
    public void the_employee_data_we_get_having_must_match_with_globaly_stored_employee(String string) {
